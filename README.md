# Bookbot
A tool to count the number of words and characters found in a book.

## Setup 
Add the .txt file in the /books directory

## Build Docker Container
`docker build . -t bookbot:latest`

## Run Docker Container
`docker run bookbot book_filename`
...
`docker run bookbot frankenstein.txt`
